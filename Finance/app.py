...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("symbol wrong boi")
        try:
            shares = int(request.form.get("shares"))
        except:
            return apology("shares muyst be int")

        if shares <= 0:
            return apology("shares ned to be positive int")
...
def quote():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            return apology("enter symbol plz boi")

        item = lookup(symbol)

        if not item:
            return apology("invalid symobl dummy")
...
def register():
    ...
    if (request.method == "POST"):
        ...
        if not username:
            return apology('plz enter username')
        elif not password:
            return apology('i ned pass')
        elif not confirmation:
            return apology('i require pass conf')

        if password != confirmation:
            return apology('wrong pass man')
        ...
        try:
            ...
            return apology('be more original')
    else:
...
def settings():
    ...
    if (request.method == "POST"):
        ...
        if not username:
            ...
            return apology('i ned new pass')
        elif newpass == password:
            return apology('i said new pass')
        # elif password != hash
...
def sell():
    ...
    if request.method == "POST":
        ...
        if shares <= 0:
            return apology("it gotta be positinve mang")
        ...
        if shares_owned < shares:
            return apology("you dont got that")
